        ...
        <div class="container">
            <div class="row service-single">
                    ...
                    <div class="block-aside-wrapper">
                      ...
                      <?php if($article['video_url']): ?>
                          <div class="block-aside__wrapper widget block-aside" id="video-block">
                              <h4 class="block-aside__title">Відео огляд</h4>
                            ...
                            <div class="block-aside__content no-indent">
                                <nav class="nav-aside">
                                    <ul>
                                        ...
                                        <li>
                                            <a href="/service/<?=$service['alias']?>" title="<?=$service['name_ua']?>">
                ...
                <div class="col-12 col-sm-7 col-md-8 service-content">
                    ...
                    <div class="text-center"><a class="btn btn-border btn-invert otzivi-btn" href="/prays-list"><span><?=$dictionary['SeeFullPrice'][$lang]?></span> </a></div>
