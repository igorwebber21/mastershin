    ...
    <div class="block">
        <div class="container">
            <div class="form-card" id="registrationWrapp">
                ...
                <div class="text-wrapper register-title">
                    <p class="text-center">
                        Зарегистрируйтесь на <strong>MegaShop Demo</strong><br>
                        Вы сможете быстрее осуществлять новые заказы, отслеживать историю Ваших заказов,
                        а также добавлять товары в Избранное
                    </p>
                </div>
                ...
                <form id="registrationForm" class="account-create" action="#" autocomplete="off">
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-6 col-xs-12 register-main">
